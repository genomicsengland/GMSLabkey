...
Feature: Validation Performed for GMS plated_sample table against the Data Dictionary
  Scenario Outline: Validation Performed for Field in plated_sample table against the Data Dictionary
  ...
  Scenario Outline: Validation Performed for Data Type in plated_sample table against the LabKey Database
    Given the user launches the Labkey application
