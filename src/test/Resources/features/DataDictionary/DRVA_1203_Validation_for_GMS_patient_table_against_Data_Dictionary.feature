...
Feature: Validation Performed for GMS patient table against the Data Dictionary
  Scenario Outline: Validation Performed for Field in patient table against the Data Dictionary
  ...
  Scenario Outline: Validation Performed for Data Type in patient table against the LabKey Database
    Given the user launches the Labkey application
